...
public class ModelTest {
    ...
    class UserBehaviorTest {
        ...
        void testValidEvent() {
            UserBehavior event = UserBehavior.builder()
                    .userId("user123")
                    .actionType("LOGIN")
                    .ip("192.168.1.1")
        ...
        void testEqualsAndHashCode() {
            long now = System.currentTimeMillis();
            UserBehavior event1 = UserBehavior.builder()
                    .userId("user123")
                    .actionType("LOGIN")
                    .ip("192.168.1.1")
                    .timestamp(now)
            ...
            UserBehavior event2 = UserBehavior.builder()
                    .userId("user123")
                    .actionType("LOGIN")
                    .ip("192.168.1.1")
                    .timestamp(now)
    ...
    class AlertEventTest {
        ...
        void testFromRuleMatch() {
            ...
            List<UserBehavior> events = Arrays.asList(
                    createEvent("user1", "192.168.1.1", baseTime),
        ...
        void testAlertLevelMedium() {
            ...
            List<UserBehavior> events = Arrays.asList(
                    createEvent("user1", "192.168.1.1", 1000),
                    createEvent("user1", "192.168.1.1", 2000),
                    createEvent("user1", "192.168.1.1", 3000)
            );
        ...
        void testAlertLevelHigh() {
            ...
            List<UserBehavior> events = Arrays.asList(
                    ...
                    createEvent("user1", "192.168.1.1", 2000),
                    createEvent("user1", "192.168.1.1", 3000),
                    createEvent("user1", "192.168.1.1", 4000),
                    createEvent("user1", "192.168.1.1", 5000),
        ...
        void testAlertLevelCritical() {
            ...
            List<UserBehavior> events = Arrays.asList(
                    ...
                    createEvent("user1", "192.168.1.1", 5000),
                    createEvent("user1", "192.168.1.1", 6000),
                    createEvent("user1", "192.168.1.1", 7000),
                    createEvent("user1", "192.168.1.1", 8000),
                    createEvent("user1", "192.168.1.1", 9000)
            );
        ...
        void testFromRuleMatchWithNullRule() {
            ...
            assertThrows(IllegalArgumentException.class, () -> 
                    AlertEvent.fromRuleMatch(null, events));
        }
        ...
        void testFromRuleMatchWithEmptyEvents() {
            ...
            assertThrows(IllegalArgumentException.class, () -> 
                    AlertEvent.fromRuleMatch(rule, Arrays.asList()));
        }
